...
for i in {error_log.sh,add-repo.sh,search.sh,dep-tree.sh,version-constraints.sh,checks.sh,download.sh,install-local.sh,upgrade.sh,remove.sh,update.sh,query-info.sh}; do
